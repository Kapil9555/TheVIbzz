    ...
    <>
      <Grid container sx={{ bgcolor: 'black', }}>
        ...
        <Grid container sx={{ justifyContent: 'center', height: '230px',bgcolor: 'black', }}>
          ...
          <Grid itemlg={12} md={12} sm={11} xs={11} sx={{ display: 'flex', justifyContent: 'center', }}>
            <Box sx={{ width: '600px', height: '35px',borderRadius:'2px', border: '1px solid white', display: 'flex', justifyContent: 'space-between', }}>
              ...
              <Box sx={{ width: {lg:'12%', md:'12%', sm:'12%', xs:'15%'}, bgcolor: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', }}>
                <Typography sx={{ fontSize: '11px', fontWeight: '900' }}>SIGN UP</Typography>
        ...
        <Grid container sx={{ bgcolor: 'white', }}>
          <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'space-evenly', alignItems: 'center', flexDirection: 'column',  }}>
            <Box sx={{ width: '130px', height: '100px', }}>
              <img src={greylogo} alt='logo' width={'100%'} height={'100%'} />

            </Box>
            <Box sx={{ width: {lg:'450px', md:'450px', sm:'450px', xs:'350px'}, height: '75px', mt: '50px',  }}>
          ...
          <Grid container>
            <Grid item lg={5} md={5} sm={12} xs={12} sx={{  display: 'flex', justifyContent: {lg:'right', md:'right', sm:'center', xs:'center'}, alignItems: 'center', flexDirection:{lg:'row', md:'row', sm:'column', xs:'column'} }}>
              ...
              <Box sx={{ width: {lg:'400px', md:'400px', sm:'400px', xs:'330px'}, ml: '6px',mt:{lg:'0px', md:'0px', sm:'10px', xs:'10px'} }}>
            ...
            <Grid item xs={12} sx={{display:'flex', justifyContent:'center', alignItems:'flex-start', mt:'40px'}}>
              ...
              <Box sx={{ width: '50px', height: '50px', }}>
                <img src={visa} alt='visa' width={'100%'} height={'50%'} />

              </Box>
              <Box sx={{ width: '50px', height: '50px', }}>
                <img src={mastercard} alt='visa' width={'100%'} height={'50%'} />
              </Box>
              <Box sx={{ width: '50px', height: '50px',}}>
                <img src={paypal} alt='visa' width={'100%'} height={'50%'} />
              </Box>
              <Box sx={{ width: '50px', height: '50px', }}>
                <img src={amercianexp} alt='visa' width={'100%'} height={'50%'} />
              </Box>
              <Box sx={{ width: '50px', height: '50px',  }}>
                <img src={webmoney} alt='visa' width={'100%'} height={'50%'} />
              </Box>
              </Box>
            </Grid>
